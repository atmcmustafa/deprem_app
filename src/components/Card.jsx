const Card = ({ mag, title, depth, date, elapsed_time }) => {
  return (
    <div className="rounded-lg p-4 bg-zinc-100 max-w-6xl mx-auto flex gap-5 items-center mt-4 duration-300 dark:bg-slate-900">
      <span
